...
export class AvaliacoesComponent implements OnInit {
  ...
  itemsPorTime: { [key: string]: any[] } = {
    ...
    PreVendas: [
      ...
      { tipo: 'time', nome: 'Meta do time de contratos fechados para as esteiras da empresa', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'SLA de resposta dos Suspects 1 dia útil para agendamento de reuniões alterar por Taxa de conversão de 25% das oportunidades atendidas', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'empresa', nome: 'MRR (Monthly Recurring Revenue)', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Churn Rate - Geral', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Margem de Lucro', requisito: 'Indispensável', peso: 'C', },
    ],
    ...
    HeadCS: [
      ...
      { tipo: 'time', nome: 'Churn rate - Marketing <= à 30%;', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Resposta das NPS - Geral acima 70%;', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Garantir a alocação de horas time em >= à 90%;', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Garantir a meta de Upsell estipulada para o ano da empresa.', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'empresa', nome: 'MRR (Monthly Recurring Revenue)', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Churn Rate - Geral', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Margem de Lucro', requisito: 'Indispensável', peso: 'C', },
    ],
    ...
    AnalistaFinanceiro: [
      ...
      { tipo: 'time', nome: 'Manter a inadimplência mensal abaixo da meta de 10%.', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Garantir a cobrança de 100% dos clientes dentro do mês de competência.', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Manter as despesas operacionais sob sua responsabilidade dentro do orçamento planejado;', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'empresa', nome: 'MRR (Monthly Recurring Revenue)', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Churn Rate - Geral', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Margem de Lucro', requisito: 'Indispensável', peso: 'C', },
    ],
