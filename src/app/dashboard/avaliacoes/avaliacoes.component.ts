...
export class AvaliacoesComponent implements OnInit {
  ...
  itemsPorTime: { [key: string]: any[] } = {
    ...
    RH: [
      ...
      { tipo: 'time', nome: 'Manutenção de taxa de turnover dentro da meta estabelecida pela empresa', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Meta de NPS (Net Promoter Score) interno de satisfação dos colaboradores', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Manter os custos com rescisões (demissões e pedidos de demissão) dentro do orçamento previsto', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'time', nome: 'Aumentar o tempo médio de permanência dos colaboradores na empresa', requisito: 'Indispensável', peso: 'B', },
      { tipo: 'empresa', nome: 'MRR (Monthly Recurring Revenue)', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Churn Rate - Geral', requisito: 'Indispensável', peso: 'C', },
      { tipo: 'empresa', nome: 'Margem de Lucro', requisito: 'Indispensável', peso: 'C', },
    ],
